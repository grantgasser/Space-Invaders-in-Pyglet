...
#---------------------------
# Find these comments and add missing code!
#---------------------------

# ------------------------------
# Create a 1200x800 window, captioned "Space Invaders", and not resizable
# Set the location of the upper left part of the window to (300,50)
# (~2 lines)
window =
...
# ------------------------------
# load the images into these objects
# HINT: the image files are in the 'sprites' folder which is in the 'res' folder
# So path of the space image is res/sprites/space.jpg
# (5 lines)
space =
player_image =
player_laser =
...
#---------------------------
# Create a label called 'player health' at the location (1000,650)
# (1 line)
text3 =
text3.italic = True
text3.bold = True
...
#---------------------------
# This function is missing something. The game will not register that a key
# has been pressed until this bug is fixed! (HINT: how does Pyglet handle events?)
# (1 line)
